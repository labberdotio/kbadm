...
//// public class JdbcTest6 extends TestCase {
...
//	}
//
//	public Document checkDocument(String docname) throws SQLException, KBException {
//
...
//
//		Collection<DocumentChunk> list2 = this.runDocumentChunkStatement(
//			"SELECT * FROM document_chunk WHERE document_id = '" + documentId.replace("'", "''") + "';"
//		);
//
