...
// public class ValidatorTest2 extends TestCase {
public class ValidatorTest2 {
	 ...
	 */
	// public ValidatorTest2(String testName) {
	// 	super(testName);
	// }
	...
	// 	return new TestSuite(ValidatorTest2.class);
	// }
...
"Ten Things to Know About ModelOps.pdf", 
	...
	public void testValidateDocument() throws SQLException, KBException {
		...
		String[] documentNames = this.getDocumentNames();
